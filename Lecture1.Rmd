...
- Asside from the mathematical implication that a system of equation represent, it also has an economic meaning:
...
## Changing the model: expectations and random shocks
